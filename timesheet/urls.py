...
urlpatterns = [
    path('my-timesheets/', my_timesheets, name='my-timesheets'),
    path('approve/<int:timesheet_id>/', approve_timesheet, name='approve-timesheet'),
    path('export/csv/', export_timesheets_csv, name='export-timesheets-csv'),
    path('edit/<int:pk>/', edit_timesheet, name='edit-timesheet'),
    path('delete/<int:timesheet_id>/', delete_timesheet, name='delete-timesheet'),
    path('c-off/', my_c_offs, name='my-c-offs'),
    path('apply-c-off/', apply_c_off, name='apply-c-off'),
    path('comp-off-approvals/', comp_off_approval_view, name='comp-off-approvals'),
    path('resubmit-timesheet/<int:pk>/', resubmit_timesheet, name='resubmit-timesheet'),
    path('generate-timeslots/', generate_timeslots, name='generate-timeslots'),
    path('submit-timesheet/', submit_timesheet, name='submit-timesheet'),
    path('load-tasks/', load_tasks_for_employee, name='load-employee-tasks'),
